...
public class BuscarRecetas extends AppCompatActivity implements AdapterBuscarRecetas.OnItemClickListener {
    ...
    private int cont = 0;
    private  WhatToCook.Model.AdapterBuscarRecetas adapter;
    private Intent i;
    private String s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ingrediente=findViewById(R.id.ingredienteInput);
        //texto = findViewById(R.id.contenido);
        //textoEditText=findViewById(R.id.textoInput);
       // ingredientesAñadidos = findViewById(R.id.ingredientesAñadidos);
